...
% move background file inside the output directory
if(exist('backgroundState.png','file'))
    movefile('backgroundState.png',strcat(sol.state,'/backgroundState.png')); 
    delete "backgroundState.png";
    close all;
end
