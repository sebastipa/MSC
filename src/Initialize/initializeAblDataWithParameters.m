function abl = initializeAblDataWithParameters(sol, deltat_i, lapse_i)
...
% overwrite parametric values 
abl.dTdz = lapse_i/1000;
abl.dTH  = deltat_i;

% set ustar, H1, H2 and fc
abl.uStar            = 0.41 * norm(abl.Uref,2) / log(abl.Href / abl.z0);
abl.H1               = 2*abl.Href;
abl.H2               = abl.H - abl.H1;
